...
class PageRelativeWeightAdder():
    ...
    def add_relative_page_weights(self, line):
        ...
        page_numbers = [x.number for x in line.pages]
        ...
        for current_page_index in range(len(line.pages)):
            ...
            #print(f"Current page number: {line.pages[current_page_index].number}, weight assigned: {line.pages[current_page_index].weight}")
            ...
            line, weight_increment = self._recursively_traverse_page_ordering_rules_dict_reassigning_weights(line = line, page_numbers = page_numbers, initiating_page_index = current_page_index, current_page_index = current_page_index, weight_increment = weight_increment)
        
        return line
    
    def _recursively_traverse_page_ordering_rules_dict_reassigning_weights(self, line, page_numbers, initiating_page_index, current_page_index, weight_increment):
        ...
        lower_page_weight_value_indexs = [x for x in [page_numbers.index(y) for y in lower_page_weight_values] if x < initiating_page_index]
        
        lower_page_weight_value_indexs = sorted(lower_page_weight_value_indexs)
        ...
        for lower_page_weight_index in lower_page_weight_value_indexs:
            ...
            #print(f"Current recursive page number: {line.pages[lower_page_weight_index].number}, weight assigned: {line.pages[lower_page_weight_index].weight}")
            weight_increment += 1
